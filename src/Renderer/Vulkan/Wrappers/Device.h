...
namespace Renderer
{
	...
	static VKAPI_ATTR VkBool32 VKAPI_CALL debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageType, const VkDebugUtilsMessengerCallbackDataEXT* pCallbackData, void* pUserData)
	{
		...
		case VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT: ms = 'V'; break;
		case VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT: ms = 'E'; break;
		case VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT: ms = 'W'; break;
		case VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT: ms = 'I'; break;
		default: ms = 'U'; break;
		}
		...
		{
		case 7: mt = "General | Validation | Performance"; break;
		case 6: mt = "Validation | Performance"; break;
		case 5: mt = "General | Performance"; break;
		case 4: mt = "Performance"; break;
		case 3: mt = "General | Validation"; break;
		case 2: mt = "Validation"; break;
		case 1: mt = "General"; break;
	...
	public:
		...
		void BuildInstance(bool debugLayers)
		{
...

			{
				...
				for (auto extension : glfwExts)
					extensions.instanceExtensions.emplace_back(extension);
			}
			...
			if (debug)
			{
				...
				if (func != nullptr) {
					func(instance, &messengerInfo, nullptr, &debugMessenger);
				}
				else {
					LogError("Failed to initialise debug layers");
				}
		...
		void BuildLogicalDevice(VkQueue* presentQueue)
		{
			...
			else LogInfo("Seperate compute command queues not supported");
		}
